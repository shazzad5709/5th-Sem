...
images = sorted(glob.glob('D:/Coding/5th-Sem/DBMS/ibtd/*.jpg'))
masks = sorted(glob.glob('D:/Coding/5th-Sem/DBMS/ibtd/Mask/*.bmp'))

file = open('D:/Coding/5th-Sem/DBMS/data.txt', 'w')
